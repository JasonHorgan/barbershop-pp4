...
I asked Chat GPT to create a logo for me which I then used for the favicon. You can see the full logo, which was not used anywhere else on site, here:

![Logo](documentation/barneyslogo.webp)
